  ...
  GuideTopic(
    ...
    sections: [
      GuideSection(
        ...
        examples: const [
          GuideExample('farm',
              {'id': 'pertanian; ladang usaha tani', 'en': 'farm'}),
          GuideExample('field',
              {'id': 'ladang', 'en': 'field'}),
          ...
          GuideExample('soil',
              {'id': 'tanah', 'en': 'soil'}),
          GuideExample('The farmer works in the field',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('to grow',
              {'id': 'menumbuhkan; menanam', 'en': 'to grow'}),
          ...
          GuideExample('We water the plants every morning',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('honey',
              {'id': 'madu', 'en': 'honey'}),
          GuideExample('barn',
              {'id': 'lumbung; kandang', 'en': 'barn'}),
          GuideExample('The chickens lay eggs every day',
    ...
    sections: [
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('Fishermen go to sea early in the morning',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('We watch fish at the aquarium',
    ...
    sections: [
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('I have a job interview tomorrow',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('She got a promotion last month',
              {'id': 'Dia naik jabatan bulan lalu', 'en': 'She got a promotion last month'}),
          GuideExample('I have a business trip next week',
    ...
    sections: [
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('to grill',
              {'id': 'membakar; memanggang', 'en': 'to grill'}),
          GuideExample('to mix',
              {'id': 'mengaduk; mencampur', 'en': 'to mix'}),
          GuideExample('I boil the eggs for ten minutes',
              {'id': 'Saya merebus telur sepuluh menit', 'en': 'I boil the eggs for ten minutes'}),
          GuideExample('She bakes bread every weekend',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('spoon',
              {'id': 'sendok', 'en': 'spoon'}),
          GuideExample('Cut the vegetables with a knife',
    ...
    sections: [
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('The workers build a new school',
    ...
    sections: [
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('She withdraws money at the ATM',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('This shop gives a big discount',
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('The customer is always right',
      ...
      GuideSection(
        ...
        examples: const [
          GuideExample('science',
              {'id': 'sains; ilmu pengetahuan', 'en': 'science'}),
          ...
          GuideExample('We do an experiment at school',
              {'id': 'Kami melakukan eksperimen di sekolah', 'en': 'We do an experiment at school'}),
          GuideExample('Math is my favorite subject',
    ...
    sections: [
      ...
      GuideSection(
        ...
        examples: const [
          ...
          GuideExample('The electricity comes from solar power',
