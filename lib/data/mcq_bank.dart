...
final List<McqQuestion> _jaQuestions = [
  ...
  _q(
    "Mana kata Jepang untuk 'sekolah'?",
  ...
  _q(
    "Berapa 'seratus' dalam bahasa Jepang?",
    "What is 'one hundred' in Japanese?",
    ['ひゃく (hyaku)', 'じゅう (juu)', 'せん (sen)', 'まん (man)'],
  ),
  // Sapaan.
  _q(
    "Sapaan 'selamat pagi' dalam bahasa Jepang?",
  ...
  _q(
    "Sapaan 'selamat siang' dalam bahasa Jepang?",
  ...
  _q(
    "Sapaan 'selamat malam' dalam bahasa Jepang?",
  ...
  _q(
    "Ucapan sebelum tidur dalam bahasa Jepang?",
  ...
  _q(
    "Mana kata Jepang untuk 'di mana'?",
    "Which Japanese word means 'where'?",
...
final List<McqQuestion> _enQuestions = [
  ...
  _q(
    "Apa bahasa Inggris dari 'kucing'?",
    "What is the English word for 'kucing'?",
    ['cat', 'dog', 'bird', 'fish'],
  ),
  _q(
    "Apa bahasa Inggris dari 'anjing'?",
    "What is the English word for 'anjing'?",
    ['dog', 'cat', 'horse', 'cow'],
  ),
  _q(
    "Apa bahasa Inggris dari 'burung'?",
  ...
  _q("Apa bahasa Inggris dari 'api'?", "What is the English word for 'api'?", [
    'fire',
    'water',
    'ice',
    'wind',
  ...
  _q(
    "Apa bahasa Inggris dari 'matahari'?",
    "What is the English word for 'matahari'?",
    ['sun', 'moon', 'star', 'sky'],
  ),
  _q(
    "Apa bahasa Inggris dari 'bulan' (benda langit)?",
  ...
  _q(
    'Lengkapi: There ___ a cat under the chair.',
    'Complete: There ___ a cat under the chair.',
    ['is', 'are', 'am', 'be'],
  ),
  _q(
    'Lengkapi: She ___ to school every day.',
    'Complete: She ___ to school every day.',
    ['goes', 'go', 'going', 'gone'],
  ),
  _q(
    'Lengkapi: They ___ watching TV now.',
  ...
  _q(
    'Lengkapi: The meeting is ___ Monday.',
  ...
  // Artikel & kata ganti.
  _q(
    'Lengkapi: She is ___ honest person.',
    'Complete: She is ___ honest person.',
    ['an', 'a', 'am', 'in'],
  ),
  _q(
    'Lengkapi: This is my book. It is ___.',
    'Complete: This is my book. It is ___.',
    ['mine', 'my', 'me', 'I'],
  ),
  _q(
    "Lengkapi: ___ is my sister. Her name is Rina.",
